...
/**
 * Controller class managing HTTP endpoints for member administration and self-registration.
 */
@RestController
...
@Tag(
    name = "Members",
    description = "APIs for managing members, self-registration, and administrative controls."
)
public class MemberController {
  ...
  @Operation(
      ...
      description = "Retrieves a list of all registered members in the system."
  )
  ...
  @Operation(
      ...
      description = "Retrieves detailed information of a member by their database identifier."
  )
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Enables a new user to self-register. Defaults to MEMBER role."
  )
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Updates a member's general profile information (names, address)."
  )
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Updates a member's expertise level (1-5). Restricted to Secretary."
  )
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Expertise level successfully updated"),
      @ApiResponse(responseCode = "400", description = "Invalid level range"),
      @ApiResponse(responseCode = "404", description = "Member not found with the specified ID")
  })
  ...
  /**
   * Enables a Secretary to update payment, medical certificate, and validation status.
   *
   * @param id the unique identifier of the member
  ...
  @Operation(
      ...
      description = "Enables a Secretary to update payment, certificate, and validation status."
  )
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Permanently deletes a member's record from the system."
  )
  @ApiResponses({
